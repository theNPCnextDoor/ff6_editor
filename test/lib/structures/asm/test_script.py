...
class TestScript:
    ...
    def test_from_rom(self):
        ...
        assert len(script.blobs) == 4
        assert script.blobs[0] == Blob(position=Position(0x000012), data=BlobBytes("3412"))
        assert script.blobs[1] == Blob(position=Position(0x000014), data=BlobBytes("7856"), delimiter=Bytes("FF"))
        assert script.blobs[2] == Blob(position=Position(0x000017), data=BlobBytes("ABCD"), delimiter=Bytes("00"))
        assert script.blobs[3] == String(position=Position(0x00001A), data=BlobBytes("0080D8FF"), delimiter=Bytes("88"))
