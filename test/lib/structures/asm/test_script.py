...
class TestScript:
    ...
    def test_from_rom(self):
        ...
        assert script.labels[0] == Label(position=Bytes([0x00, 0x00, 0x10]))
        assert script.labels[1] == Label(position=Bytes([0x00, 0x23, 0x01]))
        assert script.labels[2] == Label(position=Bytes([0x00, 0x67, 0x45]))
        assert script.labels[3] == Label(position=Bytes([0x00, 0xAB, 0x89]))
        assert script.labels[4] == Label(position=Bytes([0x00, 0xEF, 0xCD]))
