...
@load_rare_item_description_pointer_low_byte=C38339
  LDX #$0300
  STX $E7
  LDX $00
  NOP
...
@sustain_dance_menu
  ...
  LDA $7F
  CMP #$06
  BEQ handle_b_in_dance_menu
  LDA #$10
  TRB $45
  JSR load_tool_description
@handle_b_in_dance_menu
  LDA $09         ; No-autofire keys
  BIT #$80        ; Pushing B?
  BEQ return_from_sustain_dance_menu      ; Exit if not
  JSR exit_submenu      ; Leave submenu
@return_from_sustain_dance_menu
  RTS
