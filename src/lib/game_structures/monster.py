...
class Monster:
    ...
    morph_pack = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x11, bit_value=0x1F
    )
    morph_hit_rate = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x11, bit_value=0xE0
    )
    death_at_0_mp = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x12, bit_value=0x01
    )
    byte_12_bit_1 = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x12, bit_value=0x02
    )
    no_name = BitField(base_location=RomMap.MONSTER_DATA, position=0x12, bit_value=0x04)
    byte_12_bit_3 = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x12, bit_value=0x08
    )
    human = BitField(base_location=RomMap.MONSTER_DATA, position=0x12, bit_value=0x10)
    byte_12_bit_5 = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x12, bit_value=0x20
    )
    crit_if_imp = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x12, bit_value=0x40
    )
    undead = BitField(base_location=RomMap.MONSTER_DATA, position=0x12, bit_value=0x80)
    harder_to_run = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x13, bit_value=0x01
    )
    attack_first = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x13, bit_value=0x02
    )
    no_suplex = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x13, bit_value=0x04
    )
    ...
    no_sketch = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x13, bit_value=0x20
    )
    special_event = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x13, bit_value=0x40
    )
    no_control = BitField(
        base_location=RomMap.MONSTER_DATA, position=0x13, bit_value=0x80
    )
